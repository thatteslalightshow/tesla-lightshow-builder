...
export async function middleware(req: NextRequest) {
  ...
  // production, Vercel preview deployments, and custom domains without having
  // to pin every URL in the allowlist above (the allowlist is for explicit
  // cross-origin callers like the Capacitor mobile shell).
