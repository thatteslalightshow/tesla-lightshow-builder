...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const particles = Array.from({length:80}, () => ({
      ...
      size: Math.random()*2.5+.5, opacity: Math.random()*.6+.1,
    ...
    <div className={styles.page}>
      ...
      <main className={styles.hero}>
        <div className={styles.heroInner}>
          <div className="badge badge-red" style={{marginBottom:'1.5rem'}}>⚡ Compatible with all Tesla models</div>
          <h1 className={styles.heroTitle}>Your music.<br/><span className={styles.heroAccent}>Your light show.</span></h1>
          <p className={styles.heroSub}>Upload any song, watch beat detection work in real time, and see your Tesla come alive in 3D — then export directly to USB in seconds.</p>
          <div className={styles.heroCta}>
            <Link href="/auth?mode=signup" className="btn btn-primary btn-lg">Build your first show →</Link>
